...
def extract_symptoms(patient_text: str, conversation_history: Optional[List[str]] = None,
    ...
    try:
        ...
        # Network/backend failure (Ollama not running, API timeout, etc).
        # Fail soft into NEEDS_MORE_INFO rather than crashing the app --
        # the red_flags rule layer still runs independently on raw text.
        return SymptomRecord(
            follow_up_question="I'm having trouble processing that right now. "
